...
def gen_train_data(c_path_buyer_features, c_path_edge_features, c_path_train_label):
	...
	train_feats = [
		...
		, np.array(train_feat_trade_num,dtype=np.float32)[indices]
		, np.array(train_feat_avg_trade_amount,dtype=np.float32)[indices]
